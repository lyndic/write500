...
def create_engine(*args, **kwargs):
    ...
    :param strategy='plain': selects alternate engine implementations.
        ...
        * the ``mock`` strategy, which dispatches all statement
          ...
          See `example in the aboutus
          <http://docs.sqlalchemy.org/en/latest/aboutus/metadata_schema.html#how-can-i-get-the-create-table-drop-table-output-as-a-string>`_.
